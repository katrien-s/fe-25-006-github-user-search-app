...
function createSVGElement(svgString) {
	...
	return template.content.firstChild; // Create SVG element from string safely
}
...
function updateToggleUI() {
	...
	toggleText.textContent = activeTheme === 'dark' ? 'light ' : 'dark ';
	...
	const svgElement = createSVGElement(
		activeTheme === 'dark' ? sunSVGString : moonSVGString
	);

	toggleIcon.appendChild(svgElement);
